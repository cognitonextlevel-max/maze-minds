...
const steps = [
  {
    ...
    title: "Discover",
    description:
      "Complete a short free Learning Survey to help us understand your child's strengths, challenges, learning style, and support needs.",
    image: "/images/brand/girl_laptop.png",
    accent: "bg-brand-sky",
  ...
  },
  {
    ...
    description:
      "Schedule a Learning Snapshot where we identify support areas, discuss goals, and create a personalized learning pathway built around how your child learns.",
    image: "/images/brand/boy_glasses.png",
  ...
  },
  {
    ...
    title: "Grow",
    description:
      "Students participate in engaging 1-on-1 virtual sessions designed to strengthen academic and cognitive skills over time. Progress updates delivered to you after every session.",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 md:mb-24">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-700 tracking-tight leading-[1.05] text-brand-navy">
              ...
              <span className="text-brand-coral">Real progress.</span>
            </h2>
          </div>
          <p className="text-brand-navy/70 text-base md:text-lg leading-relaxed max-w-sm hidden md:block">
            We don&apos;t guess. We uncover the why &mdash; then build a plan around how your child actually learns.
          </p>
        </div>
        ...
        >
          {steps.map((step) => (
            <motion.div
              ...
              className={`group relative p-8 md:p-10 rounded-[2rem] bg-white border-4 border-brand-navy ${step.shadow} ${step.shadowHover} transition-shadow duration-300 cursor-grab active:cursor-grabbing flex flex-col h-full z-10 bg-grid-pattern`}
            >
              ...
              {/* Step image */}
              <div className={`relative mb-6 rounded-2xl overflow-hidden h-44 flex items-center justify-center pointer-events-none ${step.accent}/10`}>
                <img
                  src={step.image}
                  alt={step.title}
              ...
              <h3 className="font-display text-2xl md:text-[26px] font-800 text-brand-navy tracking-tight mb-3 leading-tight pointer-events-none">
                {step.title}
              </h3>
